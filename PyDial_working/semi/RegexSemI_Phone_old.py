...
class RegexSemI_Phone(RegexSemI.RegexSemI):
    ...
    def create_domain_dependent_regex(self):
        ...
        #-------------------------------------------------------------------------------------------    
        self.slot_vocab["price"] = "(price|cost|expense|prix)(?!(\ ?range))"
        ...
        self.slot_vocab["isforbusinesscomputing"] = "(business|professionnelle\ computing|gaming|fun|games|work|play|jeux|gamer|travail|boulot)"
    ...
    def _set_value_synonyms(self):
        ...
        self.slot_values[slot]['good'] = "(bon|good)"
        ...
        self.slot_values[slot]['0'] = "(non|pas\ dans\ le\ cadre\ professionnelle|no\ business\ computing|not\ (used\ )*(for\ )*business(\ computing)*"
        ...
        self.slot_values[slot]['small'] = "(small|little|petite)"
        self.slot_values[slot]['large'] = "(large|big|lots|grande)(?!(\ is\ it))"
        self.slot_values[slot]['medium'] = "(medium|average|moyenne)"
        self.slot_values[slot]['dontcare'] = "any|quelquesoit\ (drive|drive|disque(\ |-)*(range|rating))"
        #-------------------------------------------------------------------------------------------    
